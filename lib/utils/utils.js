...
export function transformPropsToStyle(props) {
  ...
  return {
    ...
    ...(props.shapeDirection && {
      "&:before": { borderColor: getColor(props.backgroundColor) },
    }),
    ...
    ...(props.transformTranslate && {
      transform: `translate(${props.transformTranslate})`,
    }),
    ...(props.transformRotate && {
      transform: `rotate(${props.transformRotate})`,
    }),
