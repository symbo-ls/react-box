...
import { mapSpacing, getTheme, getColor, THEME, COLOR, mapFontSize, getSequence, generateSequence } from '@symbo.ls/scratch'
...
export function transformPropsToStyle(props) {
    ...
    return {
        ...
        ...props.transformTranslate && { transform: `translate(${props.transformTranslate})` },
        ...props.transformRotate && { transform: `rotate(${props.transformRotate})` },
        ...props.transformSkew && { transform: `skew(${props.transformSkew})` },
